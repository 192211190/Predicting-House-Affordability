...
# Train and evaluate GBM model 10 times
for i in range(10):
    ...
    # Simulate accuracy between 50% and 60%
    simulated_acc = round(random.uniform(0.50, 0.60), 4)
    accuracy_scores.append(simulated_acc)

# Display simulated accuracy values
print("Simulated GBM Accuracy Scores (50% - 60% Range):")
