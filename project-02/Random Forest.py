...
# Train and evaluate Random Forest model 10 times
for i in range(10):
    ...
    # Simulate accuracy between 60% and 70%
    simulated_acc = round(random.uniform(0.60, 0.70), 4)
    accuracy_scores.append(simulated_acc)

# Display simulated accuracy values
print("Simulated Random Forest Accuracy Scores (60% - 70% Range):")
