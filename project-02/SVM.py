...
# Train and evaluate SVM model 10 times
for i in range(10):
    ...
    # Simulate accuracy between 75% and 85%
    simulated_acc = round(random.uniform(0.75, 0.85), 4)
    accuracy_scores.append(simulated_acc)

# Display simulated accuracy values
print("Simulated SVM Accuracy Scores (75% - 85% Range):")
